...
from db import db
# Activan los modelos 
from controllers.vehiculo import Vehiculo
from controllers.categoria import Categoria
app = Flask(__name__)
# "mysql://username:password@servidor/nombre_bd"
# https://flask-sqlalchemy.palletsprojects.com/en/2.x/config/#connection-uri-format
app.config['SQLALCHEMY_DATABASE_URI'] = "mysql://root:root@localhost/vehiculo"
api = Api(app)
...
# Rutas de mi Api
api.add_resource(Producto, '/producto/<string:nombre>','/vehiculo')
