...
class MiPrimeraVista(APIView):
      ...
      def post(self,request, format=None):
             ...
             print(serializador.error_messages)
             ...
             if (serializador.is_valid()):
                    almacen = {
                          'nombre': serializador.validated_data.get('nombre'), 'direccion': serializador.validated_data.get('direccion')
                    }             
